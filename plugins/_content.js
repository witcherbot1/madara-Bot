...
// Cuentas
const response = await fetch('https://raw.githubusercontent.com/omar-lite/madara-Bot/master/plugins/mnnn.js?token=GHSAT0AAAAAACUSDJXNVXRQ4CWFG5MXXHNOZUR4WCA')  
...
// Fake
global.fkontak = { "key": { "participants":"0@s.whatsapp.net", "remoteJid": "status@broadcast", "fromMe": false, "id": "مرحبا" }, "message": { "contactMessage": { "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:y\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD` }}, "participant": "0@s.whatsapp.net" }
...
global.waitt = "⏳ *`انتظر قليلا....`*\n*✪✦✦✦✦⊹⊹⊹⊹⊹⊹✪* `40%`"
global.waittt = "⌛ *`جاري التحميل...`*\n*✪✦✦✦✦✦✦⊹⊹⊹⊹✪* `60%`"
global.waitttt = "⏳ *`جاري الانتهاء....`*\n*✪✦✦✦✦✦✦✦✦⊹⊹✪* `80%`"
global.waittttt = "⌛ *`تم الانتهاء...`*\n*✪✦✦✦✦✦✦✦✦✦✦✪* `100%`"

global.destraba = `⏰الغاء القفل⏰*
𝐇𝐀𝐑𝐋𝐄𝐘 𝐋𝐈𝐆𝐇𝐓
2024 🐦💗
