...
handler.help = ['اهبل', 'خروف', 'كوكو', 'puto', 'puta', 'manco', 'manca', 'rata', 'prostituta', 'prostituto'].map(v => v + ' @tag | nombre')
handler.tags = ['calculator']
handler.command = /^اهبل|خروف|puto|puta|manco|manca|rata|prostituta|prostituto/i
